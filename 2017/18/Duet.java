...
public class Duet
{
	...
	{
		Duet d = new Duet(); // Create a new instance of the class
		d.partOne(); // Call the partOne method
	}
	...
	private void partOne() // For part one of the challenge
	{
		...
		while (executing) // While we are executing
		{
			...
			{
				if (getRegisterValue(operand1) > 0) // If the value of the register is greater than 0
				{
